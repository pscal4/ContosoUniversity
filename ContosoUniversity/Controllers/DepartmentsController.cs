...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            // Read the department to be updated.
            ...
            {
                // Uses the posted form values to create a department entity so that the Edit page can be redisplayed with an error message
                // As an alternative, you wouldn't have to re-create the department entity if you display only an error message without redisplaying the department fields
            ...
            // Put that original RowVersion property value in the OriginalValues collection for the entity.
           _context.Entry(departmentToUpdate).Property("RowVersion").OriginalValue = rowVersion;
                ...
                s => s.Name, s => s.StartDate, s => s.Budget, s => s.InstructorID))
            {
                ...
                {
                    // Gets the affected Department entity that has the updated values from the Entries property on the exception object
                    // The Entries collection will have just one EntityEntry object
                    var exceptionEntry = ex.Entries.Single();

                    //use exceptionEntry to get the new values entered by the user and the current database values.
                    ...
                    else
                    {
                        ...
                        // Adds a error message for each column that has database values different from what the user entered 
                        ...
                        // Set the RowVersion value of the departmentToUpdate to the new value retrieved from the database. 
                        ...
                        // This is required because ModelState has the old RowVersion value.
        ...
        // The input parameter was changed from Id to a Department entity instance created by the model binder. 
        // This gives EF access to the RowVersion property value in addition to the record key.
        {
            ...
            catch (DbUpdateConcurrencyException /* ex */)
            {
                ...
                //  When concurrency error is caught, redisplay the Delete confirmation page 
